...
import heroBackgroundVideo from "../assets/Generated Video March 24, 2026 - 10_33PM (online-video-cutter.com).mp4";
...
export function Hero() {
  ...
  return (
    <div
      id="trang-chu"
      className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-b from-black via-gray-900 to-black"
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(193,39,45,0.2) 0%, transparent 70%)",
          }}
          animate={{
            scale: [1, 1.3, 1],
            opacity: [0.2, 0.4, 0.2],
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-32 w-full">
        <div className="max-w-4xl">
          ...
          >
            ...
            <span className="text-[#f0d774] tracking-[0.15em] uppercase text-sm">
          ...
          >
            ...
            <p className="text-white/80 text-xl lg:text-2xl mb-12 leading-relaxed max-w-2xl pl-8">
              Nền tảng cao cấp kết hợp công nghệ{" "}
              <span className="text-[#d4af37] font-medium">3D Mannequin</span>{" "}
              cá nhân hóa và{" "}
              <span className="text-[#d4af37] font-medium">AI Stylist</span>{" "}
              thông minh.
